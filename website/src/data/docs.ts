...
export const docArticles: DocArticle[] = [
  // 1. Getting Started: Installation Guide
  {
    ...
    title: 'Installing LamaniSync: Clinic Management System Connection Guide',
    description: 'Comprehensive installation guide for clinic management system data synchronization: Chrome extension setup, LamaniHub pairing tokens, and active tunnel verification.',
...
Your workstation is now fully operational. Appointments booked via LamaniHub on WhatsApp will now synchronize automatically into your clinic calendar.
  ...
  // 2. Getting Started: Quickstart LamaniHub
  {
    ...
    title: 'LamaniHub Dashboard Pairing & CMS Sync Token Setup',
    description: 'Configure clinic locations, generate 15-minute rotating pairing tokens, and establish secure clinic management system data synchronization with LamaniHub.',
    category: 'Getting Started',
    categorySlug: 'getting-started',
    order: 2,
    readTime: '4 min read',
...
- **Instant Revocation**: If a front-desk laptop is replaced, stolen, or decommissioned, click **Revoke Device** in the LamaniHub dashboard to sever all bridge permissions instantly.
  ...
  // 3. CMS Connection Guides: Dentrix Ascend Setup
  {
    ...
    title: 'Dentrix Ascend Setup: Cloud Dental CMS Data Synchronization',
    description: 'Step-by-step connection guide for Dentrix Ascend dental clinic management system: organization alias setup, exact-origin rules, and verified writeback.',
...
5. Only after readback confirmation does LamaniHub send the booking confirmation to the patient on WhatsApp.
  ...
  // 4. CMS Connection Guides: eClinicalWorks Setup
  {
    ...
    title: 'eClinicalWorks Setup: Web EMR Data Synchronization Guide',
    description: 'Configure eClinicalWorks (eCW) web portal data synchronization: URL discovery, authentication flags, patient lookup permissions, and session hygiene.',
    category: 'CMS Connection Guides',
    categorySlug: 'cms-connection-guides',
    order: 2,
    readTime: '6 min read',
...
- **Multiple Provider Calendars**: If your clinic has 10+ doctors, ensure your eCW schedule grid view defaults to "All Providers" or the target department.
  ...
  // 5. CMS Connection Guides: LamaniPulse Setup
  {
    ...
    title: 'LamaniPulse EHR Setup: Native Clinic Management System Bridge',
    description: 'High-performance native integration for LamaniPulse EHR: zero-config auto-detection, sub-100ms appointment sync, and mutual WebCrypto verification.',
    category: 'CMS Connection Guides',
    categorySlug: 'cms-connection-guides',
    order: 3,
    readTime: '3 min read',
...
2. **Prevent Chrome Memory Saver from Discarding the Tab**:
  ...
  {
    slug: 'custom-web-cms',
    title: 'Custom Clinic Portals: Proprietary CMS Integration & Adapter Guide',
    description: 'How to build declarative adapter manifests for custom and proprietary clinic management systems without arbitrary code or database tampering.',
    category: 'CMS Connection Guides',
    categorySlug: 'cms-connection-guides',
    order: 4,
    readTime: '7 min read',
...
4. **Zero-Update Rollout**: The manifest loads into your workstation's extension securely as data — requiring zero reinstallation or browser restarts.
  ...
  // 7. Clinic Operations: Multi-Workstation Redundancy
  {
    ...
    title: 'Multi-Workstation CMS Sync: Automatic Failover & Lease Election',
    description: 'Eliminate single points of failure in clinic management system synchronization: deploy across 2 to 5 reception desks with distributed lease election.',
...
- Even if two patients click "Confirm" on WhatsApp at the exact same millisecond, LamaniHub serializes the dispatches, guaranteeing **zero double bookings**.
  ...
  // 8. Clinic Operations: Security & Firewall
  {
    ...
    title: 'Clinic IT Security: Zero-Port Firewall Setup for CMS Data Synchronization',
    description: 'Clinic IT network security guide for clinic management system synchronization: 0 inbound ports, outbound TLS 1.3 over port 443, and PDPA compliance.',
    category: 'Clinic Operations & Deployment',
    categorySlug: 'clinic-operations',
    order: 2,
    readTime: '6 min read',
...
| **Chrome Web Store** | Manifest V3 Policy | Zero remote code execution, sandboxed CSP |
  ...
  // 9. Troubleshooting: Pairing & Drops
  {
    ...
    title: 'Troubleshooting CMS Synchronization: Pairing & Connection Drops',
    description: 'Diagnose and resolve clinic management system synchronization errors, token expiration, host permission issues, and Chrome background sleep settings.',
...
- Confirm that your workstation clock is synchronized to internet time (NTP). An incorrect system clock will cause WebCrypto certificate validation to fail.
  ...
  {
    slug: 'faq',
    title: 'Clinic Management System Synchronization FAQ: Staff & Doctors Guide',
    description: 'Frequently asked questions regarding clinic management system data synchronization, workstation speed, internet outages, and patient privacy compliance.',
    category: 'Troubleshooting & Support',
    categorySlug: 'troubleshooting-and-support',
    order: 2,
    readTime: '6 min read',
